...
# mehrere Werte gibt, die gleich häufig auftreten und somit alle den Modus bilden
# Trifft dies zu, ist der obige Code nicht korrekt, weil er nur den ersten Wert 
# abfragt, der als erster in der Reihe als häufigster Wert erscheint und nicht 
# prüft, ob danach folgende Werte den gleichen Wert haben
