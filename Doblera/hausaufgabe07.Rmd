...
for(s in c(3,4,5) ){
  ...
  output <- paste("Bei einer Standabweichung von",s, "haben",ausgezeichnet*100,"% ausgezeichnete Noten.")
  print(output)
}

Wie steht die Anzahl guter Noten in Beziehung zur Anzahl schlechter Noten? 

Die Prozentzahlen guter Noten ist jeweils geringer als die schlechter Noten.

Warum?

Dies liegt daran, dass die Gruppe kleiner ist (lediglich diejenigen mit Notenwert 13, 14 und 15) als diejenigen, die durchfallen (alle mit Notenwert 1,2,3,4)
...
2. Wie viele Studenten bekommen zumindest 10 NP?
    ...
    `r pnorm(10,mean=mu,sd=3,lower.tail=FALSE) * n` Studenten bekommen zumindest 10 Notenpunkt.
...
Das ist ein **insignifikanter** Unterschied, da 1,76 > 1,88
...
Das ist ein **signifikanter** Unterschied, 4,71 > 1,88
...
Das ist ein **signifikanter** Unterschied, da |-1,66| > 1,55
