...
Das erstere Format macht meiner Meinung nach etwas mehr Sinn, da die Versuchspersonen vorangestellt sind und es somit etwas übersichtlicher ist. 
...
Bei der Darstellung der Dichte ist gut ersichtlich, wieviele Personen eine bestimmte Reaktionszeit haben und wo Häufungen auftreten. Ebenso ist dies bei der Geigenform sichtbar. 
...
priming.by.item.wide1 <- dcast(priming.by.item,cond ~ item, value.var="RT")
...
Bei der Darstellung by Item sehen die Kurven etwas anders aus und es lässt sich erkennen, dass beispielsweise DE eine deutlich länger Reaktionszeit hervorruft als DD. Bei den Single-Trial-Daten ähneln sich die Kurven. Die Reaktionszeiten sind in den verschiedenen Bedingungen ähnlicher, bei den Wiederholungen sind jedoch höhre Peaks in der der Condition DD zu erkennen. 
