...
list_hier
- Erreichen eines Grundverständnisses von Statistik, um eigene kleine Projekte durchführen zu können
- Statistisches Wissen erlangen, um Studien kritisch hinterfragen zu können
- das Programm R Studio selbstständig verwenden können 
...
# Normaler R-Code 
Es ist natürlich auch möglich R-Code zu schreiben, ohne ihn in (R)Markdown einzubetten. Dazu geht die Aufgabe weiter mit `hausaufgabe03.R` weiter. Sie sollten die Datei auch in Ihren Ordner kopieren und einen Commit machen, bevor Sie die Kopie weiter anpassen.
